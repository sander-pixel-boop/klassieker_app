...
# --- HOOFDCODE ---
prog_time = get_file_mod_time("data/sporza_prijzen_startlijst.csv")
...
if df_raw.empty:
    st.warning("Data is leeg of kon niet worden geladen. Controleer of 'data/sporza_prijzen_startlijst.csv' bestaat.")
    st.stop()
...
if not st.session_state.sporza_selected_riders:
    ...
    with tab1:
        ...
        with st.container(border=True):
            ...
            with c_fine1: 
                to_replace = st.multiselect("❌ Selecteer renner(s) om te verwijderen:", options=st.session_state.sporza_selected_riders, help="Selecteer de renner(s) die je uit je huidige start-team wilt halen.")
