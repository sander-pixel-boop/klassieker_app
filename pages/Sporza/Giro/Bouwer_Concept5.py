...
if len(st.session_state.concept5_team) == 16:
    st.divider()
    st.subheader("Etappe Overzicht & Opstellingen")
    ...
    st.divider()
    st.info("Selecteer precies 16 renners om de etappe opstellingen te zien.")
