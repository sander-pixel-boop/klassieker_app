...
cf_pagina = st.Page("pages/Cycling_Fantasy/Classics/Cycling_Fantasy.py", title="CF Dashboard", icon="🚴")
...
scorito_giro = st.Page("pages/Scorito/Giro/Giro.py", title="[Binnenkort] Giro d'Italia", icon="🇮🇹")
