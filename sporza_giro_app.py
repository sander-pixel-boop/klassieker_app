...
if "ingelogde_speler" not in st.session_state:
    ...
    pg = st.navigation({
        "Info": [home],
        "Sporza - Giro": [sporza_giro_ai, sporza_giro_bouwer, sporza_giro_bouwer_c1, sporza_giro_bouwer_c2, sporza_giro_bouwer_c3, sporza_giro_bouwer_c5, sporza_giro_evaluator]
    })
